pub use super::super::shared_ast_types::{InterpDef, LedMapDef, ReportBadField, ReportNotArray};
pub use super::super::shared_types::{MAX_ACTIONS_PER_LEVEL, MOD_REAL_MASK_ALL, XKB_MAX_LEDS};
...
fn HandleGlobalVar(info: &mut CompatInfo, ki: &mut xkb_keymap_info<'_>, stmt: &mut VarDef) -> bool {
