...
pub mod keysym_names_h {
    ...
    #[inline]
    pub fn keysym_name_perfect_hash(key: &[u8]) -> usize {
    ...
    pub static name_to_keysym: [name_keysym; 2635] = [
        name_keysym {
            keysym: 0x30,
            offset: 0,
        },
    ...
    pub static keysym_to_name: [name_keysym; 2502] = [
        name_keysym {
            keysym: 0,
            offset: 20276,
        },
...
pub const XKB_KEYSYM_UNICODE_MIN: u32 = 0x1000100;
...
pub fn xkb_keysym_to_upper(mut ks: u32) -> u32 {
    if ks <= 0x13be_u32 {
...
pub fn xkb_keysym_is_lower(ks: u32) -> bool {
    if ks <= 0x13be_u32 {
        let m = get_legacy_keysym_entry(ks);
...
pub fn xkb_keysym_is_upper_or_title(ks: u32) -> bool {
    if ks <= 0x13be_u32 {
