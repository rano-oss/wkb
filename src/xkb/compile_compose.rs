    ...
    unsafe {
        ...
        loop {
            ...
            match opt {
                ...
                104 => {
                    usage(stdout, *argv.offset(0 as ::core::ffi::c_int as isize));
                    return EXIT_SUCCESS;
                }
                _ => {
        ...
        let mut ret: ::core::ffi::c_int = EXIT_FAILURE;
        ...
        match c2rust_current_block {
            1854459640724737493 => {
                if test {
                    ...
                    ret = if xkb_compose_table_dump(stdout, compose_table) as ::core::ffi::c_int
                        != 0
                    {
                        EXIT_SUCCESS
                    } else {
