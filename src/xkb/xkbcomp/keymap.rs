...
pub use self::ast_h::{
    xkb_file_type_to_string, xkb_map_flags, C2Rust_Unnamed_13, ExprAction, ExprActionList,
    ExprArrayRef, ExprBinary, ExprBoolean, ExprDef, ExprFieldRef, ExprIdent, ExprInteger,
    ExprKeyName, ExprKeySym, ExprKeysymList, ExprString, ExprUnary, ParseCommon, XkbFile,
    _ParseCommon, stmt_type, xkb_file_type, FILE_TYPE_COMPAT, FILE_TYPE_GEOMETRY,
    ...
    STMT_VAR, STMT_VMOD, _FILE_TYPE_NUM_ENTRIES, _STMT_NUM_VALUES,
};
...
pub use self::keymap_h::{
    ...
    XKB_OVERLAY_MAX_X11, _ACTION_TYPE_NUM_ENTRIES, _XKB_MOD_INDEX_NUM_ENTRIES,
};
            ...
            if !(*pc).computed {
                ...
                ) as ::core::ffi::c_uint
                {
                    0 => {
                        ...
                        (*pc).value = group.wrapping_sub(1 as xkb_layout_index_t) as uint32_t;
                    }
                    2 => {
                        xkb_log(
                            (*info).keymap.ctx,
        ...
        if pending_computations {
            ...
            (*info).lookup.groupIndexNames[GROUP_INDEX_NAME_LAST as ::core::ffi::c_int as usize] =
                LookupEntry {
                    ...
                    value: num_groups as uint32_t,
                };
            (*info).lookup.groupMaskNames[GROUP_MASK_NAME_LAST as ::core::ffi::c_int as usize] =
                LookupEntry {
                    name: GROUP_LAST_INDEX_NAME.as_ptr(),
                    value: (1 as uint32_t) << num_groups.wrapping_sub(1 as xkb_layout_index_t),
                };
            let mut i: darray_size_t = 0 as darray_size_t;
            ...
            lookup: C2Rust_Unnamed_17 {
                groupIndexNames: [
                    ...
                    LookupEntry {
                        ...
                        value: (*keymap).num_groups as uint32_t,
                    },
                    LookupEntry {
                ...
                groupMaskNames: [
                    ...
                    LookupEntry {
                        ...
                        {
                            (1 as uint32_t)
                                << (*keymap).num_groups.wrapping_sub(1 as xkb_layout_index_t)
                        } else {
                            0 as uint32_t
                        },
                    },
