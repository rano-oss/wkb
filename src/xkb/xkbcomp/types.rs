...
pub mod vmod_h {
    ...
    use super::{type_field, C2Rust_Unnamed_17, C2Rust_Unnamed_18};
    extern "C" {
...
pub use self::ast_h::{
    ...
    ExprKeySym, ExprKeysymList, ExprString, ExprUnary, IncludeStmt, KeyTypeDef, UnknownStatement,
    VModDef, VarDef, _ParseCommon, merge_mode, stmt_type_to_string, xkb_map_flags, ParseCommon,
...
pub use self::keymap_h::{
    ...
    C2Rust_Unnamed_9, KeycodeMatch, XkbEscapeMapName, ACTION_ABSOLUTE_SWITCH, ACTION_ABSOLUTE_X,
