...
pub mod text_h {
    ...
    use super::atom_h::xkb_atom_t;
    use super::context_h::xkb_context;
    use super::keymap_h::{xkb_action_type, xkb_mod_set, ACTION_TYPE_NONE};
    use super::stdint_uintn_h::uint32_t;
...
pub mod action_h {
    ...
    use super::xkbcommon_h::xkb_mod_index_t;
    use super::xkbcomp_priv_h::{xkb_keymap_info, xkb_parser_error};
    use super::C2Rust_Unnamed_19;
    extern "C" {
...
pub use self::ast_h::{
    stmt_type, xkb_file_type, C2Rust_Unnamed_13, ExprAction, ExprActionList, ExprArrayRef,
    ExprBinary, ExprBoolean, ExprDef, ExprFieldRef, ExprIdent, ExprInteger, ExprKeyName,
    ExprKeySym, ExprKeysymList, ExprString, ExprUnary, IncludeStmt, ModMapDef, SymbolsDef, VModDef,
...
pub use self::keymap_h::{
    ...
    XKB_MOD_NONE, XKB_OVERLAY_INVALID, _ACTION_TYPE_NUM_ENTRIES,
};
...
use self::string_h::{memcpy, memmove, memset, strdup, strlen};
