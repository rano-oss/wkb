...
#[rustfmt::skip]
symbols! {
    SYM_EOF = 0, SYM_ERROR = 1, SYM_XKB_KEYMAP = 4, SYM_XKB_KEYCODES = 5, SYM_XKB_TYPES = 6, SYM_XKB_SYMBOLS = 7, SYM_XKB_COMPATMAP = 8, SYM_XKB_GEOMETRY = 9, SYM_XKB_SEMANTICS = 10, SYM_XKB_LAYOUT = 11, SYM_INCLUDE = 12, SYM_OVERRIDE = 13, SYM_AUGMENT = 14, SYM_REPLACE = 15,
