...
pub mod keysym_names_h {
    ...
    pub unsafe extern "C" fn keysym_name_perfect_hash(
        ...
        unsafe {
            let mut T1: *const i8 =
                b"gQEXVgBVbDK59TnjkSMO7UnyrqsrcaA4\0".as_ptr() as *const i8;
            let mut T2: *const i8 =
                b"AB6xkcvEK5OHbYOD14cPYBxnVAoDGTPL\0".as_ptr() as *const i8;
    ...
    unsafe {
        if ks > XKB_KEYSYM_MAX as xkb_keysym_t {
            snprintf(
                buffer,
                size,
                b"Invalid\0".as_ptr() as *const i8,
            );
...
pub unsafe extern "C" fn xkb_keysym_from_name(
    ...
    unsafe {
        ...
        {
            if !parse_keysym_hex(
                name.offset(1 as ::core::ffi::c_int as isize) as *const i8,
                &raw mut val,
            ) {
                return XKB_KEY_NoSymbol as xkb_keysym_t;
            }
        ...
        {
            if !parse_keysym_hex(
                name.offset(2 as ::core::ffi::c_int as isize) as *const i8,
                &raw mut val,
                ...
                ) == 0 as ::core::ffi::c_int
        {
            ...
            memmove(
                tmp.offset(4 as ::core::ffi::c_int as isize) as *mut i8
                    as *mut ::core::ffi::c_void,
                tmp.offset(5 as ::core::ffi::c_int as isize) as *mut i8
