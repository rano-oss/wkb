...
impl WKB {
    ...
    fn map(&mut self, path: &Path, locale: String, layout: Option<String>) {
                                                    ...
                                                    for (i, v) in key.values.iter().enumerate() {
                                                        ...
                                                        if let Some(single_char) = single_char {
                                                            if i > self.level_keymap.len() {
                                                                ...
                                                                {
                                                                    self.level_keymap.insert(
                                                                        j,
                                                                        default_keymap::DEFAULT_MAP
                                                                            .clone(),
                                                                    )
                                                                }
                                                            }
                                                            let level = if let Some(level) =
                                                                self.level_keymap.get_mut(i)
                                                            {
                                                                level
                                                            } else {
                                                                self.level_keymap.insert(
                                                            ...
                                                            // if v.content != "none"
                                                            //     && v.content != "VoidSymbol"
                                                            //     && v.content != "any"
                                                            //     && v.content != "ISO_Level3_Shift"
                                                            //     && v.content != "NoSymbol"
                                                            //     && v.content != "KP_Separator"
                                                            // {
                                                            // println!("{:?}", v);
                                                            // println!("{:?}", locale);
                                                            // }
        ...
        // self.read_layouts(path, locale, layout);
    }
}
