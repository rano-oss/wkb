...
pub static xkb_log_level_values: [u32; 5] = [
...
pub static xkb_error_code_values: [u32; 9] = [
...
pub static xkb_feature_values: [u32; 24] = [
...
fn is_supported_enum_value_array(values: &[u32], value: u32) -> bool {
    values.contains(&value)
}
fn is_supported_flag_value(values: u32, accept_zero: bool, value: u32) -> bool {
    (accept_zero || value != 0) && values & value == value
}
pub fn xkb_feature_supported(feature: xkb_feature, value: u32) -> bool {
    match feature {
        1 => is_supported_enum_value_array(&xkb_feature_values, value),
        1000 => is_supported_enum_value_array(&xkb_error_code_values, value),
        3200 => is_supported_flag_value(XKB_CONTEXT_FLAGS_VALUES, true, value),
        5100 => is_supported_enum_value_array(&xkb_log_level_values, value),
