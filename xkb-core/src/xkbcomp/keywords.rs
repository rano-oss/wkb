pub use super::scanner::parser_h::{
    ACTION_TOK, ALIAS, ALPHANUMERIC_KEYS, ALTERNATE, ALTERNATE_GROUP, AUGMENT, DEFAULT,
    FUNCTION_KEYS, GROUP, HIDDEN, INCLUDE, INDICATOR, INTERPRET, KEY, KEYPAD_KEYS, KEYS, LOGO,
    MODIFIER_KEYS, MODIFIER_MAP, OUTLINE, OVERLAY, OVERRIDE, PARTIAL, REPLACE, ROW, SECTION, SHAPE,
    SOLID, TEXT, TYPE, VIRTUAL, VIRTUAL_MODS, XKB_COMPATMAP, XKB_GEOMETRY, XKB_KEYCODES,
    XKB_KEYMAP, XKB_LAYOUT, XKB_SEMANTICS, XKB_SYMBOLS, XKB_TYPES,
};
