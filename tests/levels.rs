//! Compare WKB level output against xkbcommon for all keys and layouts
//!
//! `level_keys` compares the produced character; `keysym` compares the named
//! key for keysyms that resolve to a `NamedKey`.
