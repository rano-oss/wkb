...
|-----------|-----|-----------|--------------|-------------|
| Setup (no compose) | 2.17 ms | 2.16 ms | 2.17 ms | ~same |
| Setup (with compose) | 4.57 ms | 4.01 ms | 3.99 ms | 1.1x slower |
| Key update | 73 ns | 165 ns | 163 ns | **2.3x faster** |
| Get char | 78 ns | 266 ns | 243 ns | **3.4x faster** |
| Get keysym | 78 ns | 202 ns | 202 ns | **2.6x faster** |
| Compose feed | 60 ns | 99 ns | 74 ns | **1.7x faster** |
